...
public class AnalyticsManager
{
    ...
    {
        //Kita memakai Event dan Parameter yang tersedia di Firebase (tidak memakai custom) agar dapat muncul sebagai report data di Analytics Firebase
        LogEvent(
        ...
        //Karena resourceIndex digunakan sebagai ID, maka seharusnya kita menyimpannya sebagai string buka integer
    }
